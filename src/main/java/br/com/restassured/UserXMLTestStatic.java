...
//Utilizando o Xpath
    ...
    public void devoFazerPesquisasAvançadasComXPath() {
            ...
            .then()
                ...
                //Verificar quantas pessoas tem 'n' no nome:
                .body(hasXPath("count(/users/user/name[contains(., 'n')])", is("2"))) //o '.' é para qualquer valor
                //Busca por idade:
    ...
    // O Xpath serve mais como mecanismos de busca; o XMLPath serve mais para extrair valores e refinar buscas
}
